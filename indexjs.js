...
function myFunction() { 
    ...
    var i=(Math.floor((Math.random() * 6))); //mostraría números del 0 al 5
    //alert(i);
    //console.log(who[i]);
    ...
    var j=(Math.floor((Math.random() * 4))); //mostraría números del 0 al 3
    //alert(i);
    //console.log(who[i]);
    ...
    var k=(Math.floor((Math.random() * 3))); //mostraría números del 0 al 2
    //alert(i);
    //console.log(who[i]);
    ...
    var l=(Math.floor((Math.random() * 5))); //mostraría números del 0 al 4
    //alert(i);
    //console.log(who[i]);
